...
import { avalApi } from "../../services/api.js";
import {
  PageHeader, PageContent, Button, Card, DataTable, Badge, Input,
} from "../../components/index";

export function AvalesList() {
  ...
  const cargarAvales = useCallback(() => {
    setLoading(true);
    setError(null);
    ...
    avalApi
      ...
      .catch((err) => setError(err.message || "Error al cargar los avales"))
...
*/
  ...
  return (
    <div>
      {/*<PageHeader
        title="Avales"
        subtitle="sp_aval_listar — búsqueda en servidor"
        actions={
          <Link to="/aval">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card className="p-4">
              ...
              <div className="flex gap-2">
                {/*<Input
                  placeholder="Ingrese el DNI del aval"
                  value={dni}
            ...
            <Card className="p-4">
              ...
              <div className="flex gap-2">
                {/*<Input
                  placeholder="Ingrese el ID del aval"
                  value={clienteId}
          ...
          {cliente && !loading && (
            <Card className="p-6">
              ...
              <div className="flex gap-2 mt-6 pt-4 border-t border-stone-800">
                <Link to={`/clientes/${cliente.id}/editar`}>                           {/* El link para editar el cliente encontrado 
                  <Button variant="primary">Editar</Button>
                </Link>
                <Link to="/clientes/nuevo">                             {/* El link para editar el cliente encontrado 
          ...
          <Card className="p-6">
            <div className="mb-4 flex items-center justify-between gap-4">
              <div>
                <p className="text-sm font-semibold text-stone-200">Listado completo de los avales</p>
                <p className="text-xs text-stone-500">Muestra todos los avales activos por defecto.</p>
              </div>
              <Button onClick={cargarAvales} disabled={loading} variant="secondary">
                Actualizar listado
              </Button>
            </div>
